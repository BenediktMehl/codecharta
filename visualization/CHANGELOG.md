...
- **Area-True Treemap**: a new map layout that packs the folders by their true area and keeps the buildings in the proportions the Squarified TreeMap gives them; the algorithm and its improvements are explained in the [area-true-treemap repository](https://github.com/BenediktMehl/area-true-treemap).
